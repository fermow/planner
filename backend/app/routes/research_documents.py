...
REVISION_FIELDS = ("title", "abstract", "content", "references", "tags", "direction", "status", "template", "table_headers", "table_rows", "page_size", "page_margin", "header_text", "footer_text", "citation_style")
