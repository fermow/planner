...
def export_backup():
    backup = {}
    for collection in ["deadlines", "planner", "journal", "whiteboards", "tables", "research_documents", "notification_history"]:
...
def import_backup(data: dict = Body(...)):
    count = 0
    for collection in ["deadlines", "planner", "journal", "whiteboards", "tables", "research_documents"]:
